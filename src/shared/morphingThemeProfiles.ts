...
export const MORPHING_THEME_PROFILES: Record<string, MorphingThemeProfile> = {
  ...
  'solchi-abitudine': {
    ...
    guideFigure: 'superficie incisa da passaggi ripetuti / materia con tracce obbligate',
    perceptualReference: 'surface memory / repeated path perception',
    perceptualPrinciple: 'lettura di traiettorie ricorrenti come pressione fisica accumulata',
    renderingIntent: 'costruire canali compressi, incisioni ricorrenti e solchi materici senza trasformarli in decorazione geometrica',
    spatialBias: 'fragmented',
    symmetry: 'repeatedWeak',
    density: 'streaked',
    motion: 'mechanical',
  ...
  'materia-malleabile': {
    presetId: 'materia-malleabile',
    guideFigure: 'superficie intermedia che cede / argilla scura e cera tiepida non fuse del tutto',
    perceptualReference: 'viscous deformation / material softening',
    perceptualPrinciple: 'percezione di perdita temporanea di rigidita attraverso pieghe e bordi instabili',
    renderingIntent: 'ammorbidire tracce precedenti in masse elastiche, lucide e vulnerabili, senza esplosioni o euforia cromatica',
    spatialBias: 'distributed',
    symmetry: 'none',
    density: 'membrane',
    motion: 'contraction',
  ...
  'percorsi-laterali': {
    presetId: 'percorsi-laterali',
    guideFigure: 'mappa rovinata che apre deviazioni sottili / crepe e venature tra zone distanti',
    perceptualReference: 'path integration / broken cartography',
    perceptualPrinciple: 'connessioni secondarie percepite come attraversamenti nascosti tra campi separati',
    renderingIntent: 'far emergere linee irregolari e collegamenti laterali non perfetti, evitando reti digitali, circuiti o infografiche',
    spatialBias: 'diagonal',
    symmetry: 'none',
    density: 'fragmented',
    motion: 'drift',
    closure: 'open',
    edgeBehavior: 'brokenContours',
  },
  'impronte-lavate': {
    presetId: 'impronte-lavate',
    guideFigure: 'strati residui slavati / tracce attenuate e aloni sopravvissuti',
    perceptualReference: 'residual trace / washed imprint',
    perceptualPrinciple: 'persistenza attenuata di segni precedenti come memoria visiva non eliminata',
    renderingIntent: 'lasciare fantasmi, ombre e segni parzialmente cancellati in una superficie quieta e consumata',
    spatialBias: 'fieldWide',
    symmetry: 'weak',
    density: 'residual',
    motion: 'afterimage',
